...
parser.add_argument("--region_file", action="store", dest="region_file", default="$HISTO_BASE_PATH/config/regions_preselection.json")
parser.add_argument("--variable_file", action="store", dest="variable_file", default="$HISTO_BASE_PATH/config/variables.json")
parser.add_argument("--samples_file", action="store", dest="samples_file", default="$HISTO_BASE_PATH/config/samples.yml")
