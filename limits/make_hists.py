...
if isMC:
    ...
    for syst in systematics_shapes:
        for variation in ["Up", "Down"]:
            ...
            process.Define(f"category_{syst+variation}_index", f"1.*({syst+variation}_dR_l2j<0.4 and subleadingLeptons_dxysig[0] < 3. and hnlJet_{syst+variation}_ptorig/subleadingLeptons_pt[0] < {fractionThres}  and subleadingLeptons_dxyErr[0]< 0.05 ) \
    ...
    process.Define(f"category_nominal_index", f"1.*(nominal_dR_l2j<0.4 and subleadingLeptons_dxysig[0]<3.  and hnlJet_nominal_ptorig/subleadingLeptons_pt[0] < {fractionThres}  and subleadingLeptons_dxyErr[0]< 0.05  ) \
