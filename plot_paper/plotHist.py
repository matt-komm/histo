...
mlljOS = Plot("mllj_SR","m#lower[0.3]{#scale[0.7]{#kern[-0.6]{ }llj#lower[-0.2]{#scale[0.8]{*}}}}",combine=combineOS,binRange=[0,200], unit="GeV", extraTitles=["SR OS"],yspace=1.8,outputSuffix="_OS")
...
mlljSS = Plot("mllj_SR","m#lower[0.3]{#scale[0.7]{#kern[-0.6]{ }llj#lower[-0.2]{#scale[0.8]{*}}}}",combine=combineSS,binRange=[0,200], unit="GeV", extraTitles=["SR SS"],yspace=1.8,outputSuffix="_SS")
